// shoe stop
let allProducts = [
    { id: 1, title: 'Album 1', price: 5, img: '224-explain-of-shopping-basket-project/source/Images/Album 1.png', count: 1 },
    { id: 2, title: 'Album 2', price: 15, img: '224-explain-of-shopping-basket-project/source/Images/Album 2.png', count: 1 },
    { id: 3, title: 'Album 3', price: 20, img: '224-explain-of-shopping-basket-project/source/Images/Album 3.png', count: 1 },
    { id: 4, title: 'Album 4', price: 100, img: '224-explain-of-shopping-basket-project/source/Images/Album 4.png', count: 1 },
    { id: 5, title: 'Coffee', price: 5, img: '224-explain-of-shopping-basket-project/source/Images/Cofee.png', count: 1 },
    { id: 6, title: 'Shirt', price: 50, img: '224-explain-of-shopping-basket-project/source/Images/Shirt.png', count: 1 },
]
...
const removeAllProductsBtn = $.querySelector('#purchase')
...
let existP = userBasket.some(function (product) {
  return product.id === productId
})
...
if (existP) {
  ...
  console.log('محصول از قبل وجود دارد');
  alert('محصول از قبل وجود دارد');
} else {
...
const searchInpute = $.querySelector('.search-input')

searchBtn.addEventListener('click' , ()=>{
   let searching = window.find(searchInpute.value)
